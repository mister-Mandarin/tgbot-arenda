...
async def start_admin(user_id: int, message: Message):
    ...
    await message.answer(
        "Ты великий и могучий админ в этом боте! Для тебя доступна секретная команда /iadmin для доступа к скрытым функциям.",
