...
async def generate_buzy_time(alias, date):
    time_start = []
    clear_buzy_time = []
    buzy_time = await get_halls_time(alias, date)
...
async def generate_free_time_start(alias, date):
    buzy, clear_buzy_time = await generate_buzy_time(alias, date)
    free = []
...
async def generate_free_time_end(
    time_start: str, clear_buzy_time: list[str]
) -> list[str]:
    slots = []
